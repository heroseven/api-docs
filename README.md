...
| *currency <br> Min: 3 Max: 3 | *string* | Código de la moneda en tres letras (Formato ISO 4217).   **Ejemplo**: `PEN` |
...
| fingerprint <br> Min: Max: | *string* | (opcional) Un identificador único del dispositivo usado por del cliente. **Ejemplo**: `2020`|
...
| cvv <br> Min: 2 Max: 50 | *string* | (opcional) CVV de la tarjeta. **Ejemplo**: `123` |
...
| Campo    | Tipo de dato  | Descripción  |
| :------- |:-------------:| :------------|
| *name <br> Min: 2 Max: 50 | *string* | Nombres del cliente.  |
| *last_name <br> Min: 2 Max: 50 | *string* | Apellidos del cliente. |
| *email <br> Min: 5 Max: 50 | *string* |  Dirección de correo electrónico del cliente.  |
| *currency <br> Min: 3 Max: 3 | *string* | Código de la moneda en tres letras (Formato ISO 4217).|
| *card_number <br> Min: Max: | *integer* | Numero de la tarjeta. |
| *cvv <br> Min: Max: | *integer* | CVV de la tarjeta. |
| *expiration_month <br> Min: Max: | *integer* |  Mes de expiración de la tarjeta. |
| *expiration_year <br> Min: Max: | *integer* | Año de expiración de la tarjeta. |
| fingerprint <br> Min: Max: | *string* | (opcional) Un identificador único del dispositivo usado por del cliente. |
